			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						(0, _jquery2.default)(".flex__item-content").addClass("flex__item-content--is-visible");
						(0, _jquery2.default)(".flex__item--title").addClass("flex__item--title-with-content");
					},
